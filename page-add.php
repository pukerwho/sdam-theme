...
<div class="container py-8 xl:py-12">
  ...
  <div class="flex flex-wrap xl:-mx-10">
    <div class="w-full xl:w-2/3 xl:px-10">
      <div class="content bg-gray-200 dark:bg-gray-600 rounded-lg px-6 py-4 mb-6">
        <?php the_content(); ?>
      </div>
      <div class="mb-6">
        <input type="text" placeholder="<?php _e("Посилання на ваше оголошення", "treba-wp"); ?>" class="w-full dark:bg-gray-800 text-gray-800 dark:text-gray-200 border rounded border-gray-200 dark:border-gray-500 dark:bg-dark-md py-2 px-4">
      </div>
      <div>
